export default function Home() {
  return (
    <section className="h-[calc(100vh-5rem)] flex flex-col gap-5 items-center justify-center p-4">
      ...
      <a href="/login" className="px-6 py-2 bg-transparent border-2 border-black text-black font-semibold rounded hover:bg-green-400 transition-all duration-300 disabled:opacity-50">Get Started</a>
    </section>
  )
}
